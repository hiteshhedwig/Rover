...
"""autogenerated by genpy from katana_msgs/JointMovementActionResult.msg. Do not edit."""
import sys
...
class JointMovementActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "katana_msgs/JointMovementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','katana_msgs/JointMovementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = katana_msgs.msg.JointMovementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = katana_msgs.msg.JointMovementResult()
