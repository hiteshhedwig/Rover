...
"""autogenerated by genpy from katana_msgs/JointMovementActionFeedback.msg. Do not edit."""
import sys
...
class JointMovementActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "katana_msgs/JointMovementActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','katana_msgs/JointMovementFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = katana_msgs.msg.JointMovementFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = katana_msgs.msg.JointMovementFeedback()
