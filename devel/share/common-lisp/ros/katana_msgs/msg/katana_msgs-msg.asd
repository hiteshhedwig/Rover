...
(defsystem "katana_msgs-msg"
  :depends-on (:roslisp-msg-protocol :roslisp-utils :actionlib_msgs-msg
               :sensor_msgs-msg
               :std_msgs-msg
)
  :components ((:file "_package")
    (:file "GripperControllerState" :depends-on ("_package_GripperControllerState"))
    (:file "_package_GripperControllerState" :depends-on ("_package"))
