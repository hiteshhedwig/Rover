...
(cl:defmethod cl:initialize-instance :after ((m <try2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'try2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ps3joy-msg:<try2> is deprecated: use ps3joy-msg:try2 instead.")))

(cl:ensure-generic-function 'forward_speed-val :lambda-list '(m))
(cl:defmethod forward_speed-val ((m <try2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ps3joy-msg:forward_speed-val is deprecated.  Use ps3joy-msg:forward_speed instead.")
  (forward_speed m))

(cl:ensure-generic-function 'backward_speed-val :lambda-list '(m))
(cl:defmethod backward_speed-val ((m <try2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ps3joy-msg:backward_speed-val is deprecated.  Use ps3joy-msg:backward_speed instead.")
  (backward_speed m))
