...
if("TRUE" STREQUAL "TRUE")
  set(ps3joy_SOURCE_PREFIX /home/hit_ter/rover_ws/src/ps3joy)
  set(ps3joy_DEVEL_PREFIX /home/hit_ter/rover_ws/devel)
  set(ps3joy_INSTALL_PREFIX "")
  set(ps3joy_PREFIX ${ps3joy_DEVEL_PREFIX})
else()
  set(ps3joy_SOURCE_PREFIX "")
  set(ps3joy_DEVEL_PREFIX "")
  set(ps3joy_INSTALL_PREFIX /home/hit_ter/rover_ws/install)
...
if(NOT "/home/hit_ter/rover_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hit_ter/rover_ws/src/ps3joy/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ps3joy_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "ps3joy")
...
set(ps3joy_EXPORTED_TARGETS "ps3joy_generate_messages_cpp;ps3joy_generate_messages_eus;ps3joy_generate_messages_lisp;ps3joy_generate_messages_nodejs;ps3joy_generate_messages_py")
...
set(depends "diagnostic_msgs;std_msgs;sensor_msgs;rospy;rosgraph;message_runtime")
...
set(pkg_cfg_extras "ps3joy-msg-extras.cmake")
